...
(*  FILE_LAST_MODIFIED_ON: 10/27/2009  AT: 12:24:11        *)
(***********************************************************)
//# Legal Notice:
//#    Copyright, AMX LLC, 2004-2009
...
DEFINE_CONSTANT // Amplifier Channels and Levels
...
DEFINE_CONSTANT // Digital Media Decoder Channels and Levels
...
DEFINE_CONSTANT // Digital Media Encoder Channels and Levels
...
DEFINE_CONSTANT // Digital Media Server Channels and Levels
...
DEFINE_CONSTANT // Digital Video Recorder Channels and Levels
...
DEFINE_CONSTANT // Display Channels and Levels
...
DEFINE_CONSTANT // IO Device Channels and Levels
...
DEFINE_CONSTANT // LightSystem Channels and Levels
...
DEFINE_CONSTANT // Relay Device Channels and Levels
...
DEFINE_CONSTANT // RFIDSystem Channels and Levels
...
DEFINE_CONSTANT // UPS Channels and Levels
...
DEFINE_VARIABLE // Ramping
  ...
  DEFINE_FUNCTION CHAR[DUET_MAX_HDR_LEN] DuetPackCmdHeader(CHAR cHdr[])
  {
    ...
    IF(RIGHT_STRING(cHdr,LENGTH_ARRAY(cSep)) != cSep)
  ...
  DEFINE_FUNCTION CHAR[DUET_MAX_CMD_LEN] DuetPackCmdParam(CHAR cCmd[], CHAR cParam[])
  {
    ...
    IF(FIND_STRING(cCmd,cCmdSep,1) != (LENGTH_ARRAY(cCmd)-LENGTH_ARRAY(cCmdSep)+1))
  ...
  DEFINE_FUNCTION CHAR[DUET_MAX_HDR_LEN] DuetParseCmdHeader(CHAR cCmd[])
  {
    ...
    IF(FIND_STRING(cCmd,cSep,1) > 0)
    {
      ...
      cTemp                                    = LEFT_STRING(cTemp,LENGTH_ARRAY(cTemp)-LENGTH_ARRAY(cSep))
    }
  ...
  DEFINE_FUNCTION CHAR[DUET_MAX_PARAM_LEN] DuetParseCmdParam(CHAR cCmd[])
  {
    ...
    FOR(nLoop                  = 1; nLoop <= LENGTH_ARRAY(cCmd); nLoop++)
    {
      ...
      IF(bDone                 == TRUE || nLoop >= LENGTH_ARRAY(cCmd))
      {
        ...
        cCmd                                     = MID_STRING(cCmd, nLoop + 1, LENGTH_ARRAY(cCmd) - nLoop)
